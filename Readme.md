...
The main purpose of this demo is to show how AI agents can create code that works using test-driven desgin.
...
4. Open a new terminal window. Go to src/main folder and run the following script to reset password, installing sqlcl, skills and utPLSQL as well as copying grouvee_export.json to the Oracle directory:
```
